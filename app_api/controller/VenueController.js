...
//postmande konuma göre mekan bulamk istediğimizde çalışacak fonksiyon bu 
const listVenues = function (req, res) {
    ...
    var geoOptions = {
        ...
        maxDistance: converter.radian2Kilometer(100)//konuma göre 100 km içinde arama yap demek 
    };
    try {
        Venue.aggregate([
            {
